...
public class EmissionDao {
	...
	public Node<String> getEmissionsTree() {
        ...
        while(iterator.hasNext()) {
        	...
        	cal.setTime(emission.getDate());
        	
        	if (!tree.getChildrens().contains(new Node<String>(Integer.toString(cal.get(Calendar.YEAR))))) {
        		tree.getChildrens().add(new Node<String>(Integer.toString(cal.get(Calendar.YEAR))));
        	}
        	
        	tree.getChildrenByData(Integer.toString(cal.get(Calendar.YEAR))).getChildrens().add(new Node<String>(emission.getLink()));        	
